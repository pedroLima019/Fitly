    ...
    <div className="bg-white border-b p-3 sm:p-4 flex items-center justify-between flex-shrink-0 sticky top-0">
      <div className="flex items-center gap-3 min-w-0">
        ...
        {otherUserImage ? (
          ...
          <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-green-400 to-green-900 flex items-center justify-center text-white font-bold flex-shrink-0">
