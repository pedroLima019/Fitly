...
export function ConversationList({
  ...
  const filteredConversations = useMemo(() => {
    return conversations.filter((convo) =>
      convo.personalName?.toLowerCase().includes(searchQuery.toLowerCase()),
    );
            ...
            >
              <div className="flex items-center gap-3">
                ...
                {convo.personalImage ? (
                  ...
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-blue-900 flex items-center justify-center text-white font-bold flex-shrink-0">
